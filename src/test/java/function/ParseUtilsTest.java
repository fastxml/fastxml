...
public class ParseUtilsTest {
    ...
    @Test
    public void testParseTrimString() throws ParseException {
        byte[] testBytes = "  ".getBytes();
        Assert.assertEquals(null, ParseUtils.parseTrimString(testBytes, 0, testBytes.length));

        testBytes = " \t 111".getBytes();
        Assert.assertEquals("111", ParseUtils.parseTrimString(testBytes, 0, testBytes.length));
